...
public class PersonController {
    ...
    public ResponseEntity<Iterable<Person>> getStudents() {
        return new ResponseEntity<>(
                personRepo.findAllByTypeOrderByLastnameAscFirstnameAscFathernameAsc(STUDENT_TYPE),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<Iterable<Person>> getTeachers() {
        return new ResponseEntity<>(
                personRepo.findAllByTypeOrderByLastnameAscFirstnameAscFathernameAsc(TEACHER_TYPE),
                HttpStatus.OK
        );
    }
